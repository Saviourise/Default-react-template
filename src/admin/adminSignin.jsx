...
const AdminSignin = () => {
  ...
  const handleSubmit = (event) => {
    ...
    fetch("https://a1api.onrender.com/api/admin/login", {
      method: "POST",
      ...
      .then((data) => {
        ...
        if (data.message) {
          setError(
            "An error occurred while trying to connect with the server, please check your internet connection and try again!"
          );
          return setOpen(true);
        }
  ...
  useEffect(() => {
    // console.log(process.env.https://a1api.onrender.com/)
        ...
        <div id="admin-sign-in-aside">
          ...
          >
            ...
            <polygon
              ...
              fill="#2f2e41"
            />
            <circle cx="707.33457" cy="77.37523" r="77.37523" fill="#7675ad" />
            <path
